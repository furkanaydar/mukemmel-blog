...
class Content extends Component {
    ...
    async handleSearchQuery(searchQuery) {
        ...
        let endpoint = (searchQuery.length > 0) ?
            window.location.protocol + "://" + process.env.host + "/api/post/search/" + searchQuery :
            window.location.protocol + "://" + process.env.host + "/api/" + ((this.props.activeTab == 0) ? 'posts' : 'projects')
