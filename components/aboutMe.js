            ...
            <Fade big>
                <div style={Styles.aboutMeContainer}>
                    ...
                    <div className='container' style={{ backgroundColor: 'whitesmoke', display: 'flex', marginBottom:24 }}>
                        <div style={{borderRight: '1px solid rgba(0, 0, 0, 0.1)', width: '36%', padding: 20, margin: 'auto' }}>
                            ...
                            <section style={{border:'1px solid rgba(0, 0, 0, 0.1)', fontSize: 18, textAlign: 'center', padding: 8, marginTop: 10 }}>
