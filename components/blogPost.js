...
class BlogPost extends Component {
    ...
    async handleLike() {
        ...
        await fetch(location.protocol + '://' + process.env.host + '/api/util/' + slug);
        const retrievePost = await fetch(location.protocol + '://' + process.env.host + '/api/post/' + slug);
    ...
    async handleDeletePost() {
        let slug = this.props.slug
        const res = await fetch(location.protocol + '://' + process.env.host + '/api/admin/deletePost/' + slug);
